...
|InstanceRSR| [InstanceRSR: Real-World Super-Resolution via Instance-Aware Representation Alignment](https://arxiv.org/abs/2603.24240) | Zixin Guo | Supervised | Preprint'26 | Super-resolution | |
...
|ResDiff| [ResDiff: Combining cnn and diffusion model for image superresolution](https://arxiv.org/abs/2303.08714) | Shuyao Shang | Supervised | Preprint'23 | Super-resolution | [![Stars](https://img.shields.io/github/stars/kunncheng/DiT-SR.svg?style=social&label=Star)](https://github.com/LYL1015/ResDiff) |
|OSEDiff| [One-Step Effective Diffusion Network for Real-World Image Super-Resolution](https://arxiv.org/abs/2406.08177) | Rongyuan Wu | Supervised | Preprint'24 | Super-resolution | [![Stars](https://img.shields.io/github/stars/LYL1015/ResDiff.svg?style=social&label=Star)](https://github.com/cswry/OSEDiff) |
|DiT-SR| [Effective Diffusion Transformer Architecture for Image Super-Resolution](https://arxiv.org/abs/2409.19589) | Kun Cheng | Supervised | Preprint'25 | Super-resolution | [![Stars](https://img.shields.io/github/stars/cswry/OSEDiff.svg?style=social&label=Star)](https://github.com/kunncheng/DiT-SR) |
|InvSR| [Arbitrary-steps Image Super-resolution via Diffusion Inversion](https://arxiv.org/abs/2412.09013) | Zongsheng Yue | Supervised | CVPR 25 | Super-resolution | [![Stars](https://img.shields.io/github/stars/zsyOAOA/InvSR.svg?style=social&label=Star)](https://github.com/zsyOAOA/InvSR) |
...
|SAM-DiffSR| [SAM-DiffSR: Structure-Modulated Diffusion Model for Image Super-Resolution](https://arxiv.org/abs/2402.17133) | Chengcheng Wang | Supervised | 
Preprint'24 | Super-resolution |  [![Stars](https://img.shields.io/github/stars/lose4578/SAM-DiffSR.svg?style=social&label=Star)](https://github.com/lose4578/SAM-DiffSR) |
|DiT4SR| [DiT4SR: Taming Diffusion Transformer for Real-World Image Super-Resolution](https://arxiv.org/abs/2503.23580) | Zheng-Peng Duan | Supervised | 
Preprint'25 | Super-resolution |  [![Stars](https://img.shields.io/github/stars/Adam-duan/DiT4SR.svg?style=social&label=Star)](https://github.com/Adam-duan/DiT4SR) |
...
|DTPSR| [Disentangled Textual Priors for Diffusion-based Image Super-Resolution](https://arxiv.org/abs/2603.07430) | Lei Jiang | Supervised | CVPR 2026 | Super-resolution | |
|MFSR| [MFSR: MeanFlow Distillation for One Step Real-World Image Super Resolution](https://arxiv.org/abs/2603.20690) | Ruiqing Wang | Supervised | Preprint'26 | Super-resolution | |
|DualTSR| [DualTSR: Unified Dual-Diffusion Transformer for Scene Text Image Super-Resolution](https://arxiv.org/abs/2603.14207) | Axi Niu | Supervised | Preprint'26 | Super-resolution | |
|ODTSR| [One-Step Diffusion Transformer for Controllable Real-World Image Super-Resolution](https://arxiv.org/abs/2511.17138) | Yushun Fang | Supervised | Preprint'25 | Super-resolution |[![Stars](https://img.shields.io/github/stars/RedMediaTech/ODTSR.svg?style=social&label=Star)](https://github.com/RedMediaTech/ODTSR)|
...
|AutoDIR|[AutoDIR: Automatic All-in-One Image Restoration with Latent Diffusion](https://arxiv.org/abs/2310.10123) | Yitong Jiang | Supervised | Preprint' 2023 | Image Restoration | [![Stars](https://img.shields.io/github/stars/jiangyitong/AutoDIR.svg?style=social&label=Star)](https://github.com/jiangyitong/AutoDIR)|
...
|DUO-VSR|[DUO-VSR: Dual-Stream Distillation for One-Step Video Super-Resolution](https://arxiv.org/abs/2603.22271) | Zhengyao Lv | Supervised | Preprint' 26 | Video Super-resolution ||
...
|InstaVSR|[InstaVSR: Taming Diffusion for Efficient and Temporally Consistent Video Super-Resolution](https://arxiv.org/abs/2603.26134) | Jintong Hu | Supervised | Preprint' 2026 | Video Super-Resolution ||
|HATIR|[HATIR: Heat-Aware Diffusion for Turbulent Infrared Video Super-Resolution](https://arxiv.org/abs/2601.04682) | Yang Zou | Supervised | Preprint' 2026 | Video Super-resolution ||
|Stream-DiffVSR|[Stream-DiffVSR: Low-Latency Streamable Video Super-Resolution via Auto-Regressive Diffusion](https://arxiv.org/abs/2512.23709) | Hau-Shiang Shiu | Supervised | Preprint' 2025 | Video Super-resolution ||
...
|PASDiff|[PASDiff: Physics-Aware Semantic Guidance for Joint Real-world Low-Light Face Enhancement and Restoration](https://arxiv.org/abs/2603.24969) | Yilin Ni | Supervised | Preprint'26 | Low-light Enhancemnent | |
...
|ColorFLUX|[ColorFLUX: A Structure-Color Decoupling Framework for Old Photo Colorization](https://arxiv.org/abs/2603.28162) | Bingchen Li | Supervised | CVPR 2026 | Old Photo Colorization | |
